...
const CategorySection = forwardRef(function CategorySection({ category, meals, onAdd }, ref) {
  ...
  return (
    <section ref={ref} className="mb-16">      <div className="flex items-center justify-between gap-3 mb-6 pb-5 border-b border-white/[0.08]">
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-white/[0.04] border border-white/[0.09]
                          flex items-center justify-center flex-shrink-0">
            <Icon size={14} className="text-white/55" />
          </div>
          <h3
            className="text-xl sm:text-2xl lg:text-3xl text-white/90 uppercase tracking-[0.08em] sm:tracking-[0.1em] font-light truncate"
